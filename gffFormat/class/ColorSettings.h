...
public:
	...
	static vector <uint16_t> fromRGBtoHSV(vector <uint16_t> pixel) {
	...
	static vector <uint16_t> fromRGBtoHSL(vector <uint16_t> pixel) {
	...
	static vector <uint16_t> fromRGBtoYUV(vector <uint16_t> pixel) {
	...
	static vector <uint16_t> fromHSVtoRGB(vector <uint16_t> pixel) {
	...
	static vector <uint16_t> fromYUVtoRGB(vector <uint16_t> pixel) {
	        double y, u, v;
	        uint8_t r, g, b;
	        int size = pixel.size();
	        vector <uint16_t> result;
	...
	static vector <uint16_t> fromHSLtoRGB(vector <uint16_t> pixel) {
	...
	vector <uint16_t> fromHSVtoHSL(vector <uint16_t> pixel){
		vector <uint16_t> tempRGB = ColorSettings::fromHSVtoRGB(pixel);
	...
	vector <uint16_t> fromHSLtoHSV(vector <uint16_t> pixel){
			vector <uint16_t> tempRGB = ColorSettings::fromHSLtoRGB(pixel);
	...
	vector <uint16_t> fromYUVtoHSV(vector <uint16_t> pixel){
			vector <uint16_t> tempRGB = ColorSettings::fromYUVtoRGB(pixel);
			return ColorSettings::fromRGBtoHSV(tempRGB);
	}
